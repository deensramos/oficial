...
(function (a, b) {
    ...
    function d(b) {
        return !a(b)
            ...
            .andSelf()
            .filter(function () {
                return a.curCSS(this, "visibility") === "hidden" || a
                    .expr
                    .filters
                    .hidden(this)
            })
    ...
    a
        ...
        .extend({
            ...
            scrollParent: function () {
                var b;
                return a.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(
                    this.css("position")
                )
                    ? b = this
                        .parents()
                        .filter(function () {
                            return /(relative|absolute|fixed)/.test(a.curCSS(this, "position", 1)) && /(auto|scroll)/.test(
    ...
    if (a.cleanData) {
        ...
        a.fn.remove = function (b, c) {
            return this.each(function () {
                return c || (!b || a.filter(b, [this]).length) && a("*", this)
                    .add([this])
                    .each(function () {
                        try {
...
(function (a, b) {
    ...
    a.widget("ui.mouse", {
        ...
        _mouseDown: function (b) {
            ...
            var d = this,
                e = b.which == 1,
                f = typeof this.options.cancel == "string" && b.target.nodeName
                    ? a(b.target)
            ...
            return !0 === a.data(b.target, this.widgetName + ".preventClickEvent") && a.removeData(
                b.target,
...
(function (a, b) {
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function () {
            ...
            ), this.range = a("<div></div>").appendTo(this.element).addClass(
        ...
        values: function (b, c) {
            ...
            if (arguments.length > 1) {
                this
                    .options
                    .values[b] = this._trimAlignValue(c),
                this._refreshValue(),
                this._change(null, b);
                return
            }
            ...
            this.options.values && this.options.values.length
                ? this
                    ...
                    .each(function (b, i) {
                        ...
                        d.options.range === !0 && (
                            d.orientation === "horizontal"
                                ? (b === 0 && d.range.stop(1, 1)[
                                    e
                                        ? "animate"
                                        : "css"
                                ]({
                                    left: f + "%"
                                }, c.animate), b === 1 && d.range[
                                    e
                                        ? "animate"
                                        : "css"
                                ]({
                ...
                : (
                    ...
                    b === "min" && this.orientation === "horizontal" && this.range.stop(1, 1)[
                        e
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    b === "max" && this.orientation === "horizontal" && this.range[
                        e
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    b === "min" && this.orientation === "vertical" && this.range.stop(1, 1)[
                        e
                            ? "animate"
                            : "css"
                    ]({
                    ...
                    b === "max" && this.orientation === "vertical" && this.range[
                        e
                            ? "animate"
                            : "css"
                    ]({
